...
class ProjectDesignerListWidget extends StatefulWidget {
  const ProjectDesignerListWidget({Key? key}) : super(key: key);

  @override
  State<ProjectDesignerListWidget> createState() =>
      _ProjectDesignerListWidgetState();
}

class _ProjectDesignerListWidgetState extends State<ProjectDesignerListWidget> {
  @override
  void initState() {
    super.initState();
    // Načítaj projektantov pri otvorení
          ...
          Expanded(
            child: Consumer<ProjectDesignerEditProvider>(
              builder: (context, provider, child) {
                ...
                return _buildDesignersList(provider);
              },
            ),
          ),
        ],
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer<ProjectDesignerEditProvider>(
                  builder: (context, provider, child) {
                    return Text(
                      '${provider.designers.length} projektantov',
  ...
  Widget _buildDesignersList(ProjectDesignerEditProvider provider) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final isSelected = provider.selectedDesigner?.id == designer.id;
        ...
        final itemBg = isSelected
            ? (isDark ? const Color(0xFF3E2C00) : Colors.amber.shade50)
        ...
        return InkWell(
          onTap: () {
            provider.selectDesigner(designer);
          },
  ...
  Widget _buildEmptyState() {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final iconBg = isDark
        ? [const Color(0xFF3E2C00), const Color(0xFF5C4200)]
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Pridajte prvého projektanta pomocou tlačidla hore',
            style: Theme.of(context).textTheme.bodyMedium?.copyWith(
              color: isDark ? Colors.white70 : null, // ✅
            ),
            textAlign: TextAlign.center,
